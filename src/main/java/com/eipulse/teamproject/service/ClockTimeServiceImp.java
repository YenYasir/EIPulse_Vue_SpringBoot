...
public class ClockTimeServiceImp implements ClockTimeService {
    ...
    @Autowired
    public ClockTimeServiceImp(ClockTimeRepository clockTimeRepository, EmpRepository empRepository, AttendanceRepository attendanceRepository,OfficeRegionsServiceImp officeRegionsServiceImp) {
