<template>
  <div class="d-flex">
    <aside-bar :home-path="`/manage/${emp.empId}`" style="flex: 1">
      ...
      <drop-down title="薪資管理" iconName="coin" :items="[{ name: '薪資設定', path: '/salary' }]" menuId="submenu2"></drop-down>
      ...
      <drop-down title="出勤管理" iconName="clipboard2-check" :items="[
      ...
      <drop-down title="聊天室" iconName="chat-left-text" :items="[
