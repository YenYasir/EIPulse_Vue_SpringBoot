...
const data = reactive({
  ...
  rules: {
    dictName: [{ required: true, message: "字典名稱不能為空", trigger: "blur" }],
    dictType: [{ required: true, message: "字典類型不能為空", trigger: "blur" }]
  },
});
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否確認刪除字典編號為"' + dictIds + '"的數據項？').then(function() {
