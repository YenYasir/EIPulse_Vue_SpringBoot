    ...
    <el-form size="small">
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
                ...
                <el-input-number v-model='average02' :min="1" :max="59 - average01" /> 秒執行一次
            </el-radio>
        </el-form-item>
    ...
    <el-form size='small'>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="6">
                指定
                <el-select class="multiselect" clearable v-model="checkboxList" placeholder="可多選" multiple :multiple-limit="6">
                    <el-option v-for="item in weekList" :key="item.key" :label="item.value" :value="item.key" />
                </el-select>
            </el-radio>
        </el-form-item>
