    ...
    <el-form size="small">
        ...
        <el-form-item>
            <el-radio :label="4" v-model='radioValue'>
                從
                <el-input-number v-model='average01' :min='fullYear' :max="maxFullYear - 1"/> 年開始，每
                <el-input-number v-model='average02' :min="1" :max="10" /> 年執行一次
            </el-radio>
        ...
        <el-form-item>
            <el-radio :label="5" v-model='radioValue'>
                指定
                <el-select clearable v-model="checkboxList" placeholder="可多選" multiple :multiple-limit="8">
