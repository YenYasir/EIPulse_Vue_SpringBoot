...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	/**
	 * 解決 無法直接註入 AuthenticationManager
	 *
	 * @return
	 * @throws Exception
	 */
	 ...
	 * | 如果有參數，參數表示IP地址，如果員工IP和參數匹配，則可以訪問 hasRole | 如果有參數，參數表示角色，則其角色可以訪問 permitAll
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity
				...
				.permitAll().antMatchers("/system/**").permitAll().antMatchers("/swagger-ui.html").anonymous()
