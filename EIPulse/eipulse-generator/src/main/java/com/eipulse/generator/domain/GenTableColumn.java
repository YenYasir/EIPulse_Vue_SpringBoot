...
public class GenTableColumn extends BaseEntity {
	...
	/**
	 * 顯示類型（input文本框、textarea文本域、select下拉框、checkbox復選框、radio單選框、datetime日期控件、upload上傳控件、editor富文本控件）
	 */
	...
	public static boolean isUsableColumn(String javaField) {
		// isSuperColumn()中的名單用於避免生成多余Domain屬性，若某些屬性在生成頁面時需要用到不能忽略，則放在此處白名單
