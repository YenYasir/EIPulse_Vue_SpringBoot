...
import com.eipulse.system.service.SysDeptService;
...
public class SysDeptController extends BaseController {
	...
	public AjaxResult getInfo(@PathVariable Long deptId) {
		...
		return AjaxResult.success(deptService.getObject(deptId));
	}
	...
	public AjaxResult roleDeptTreeselect(@PathVariable("roleId") Long roleId) {
		...
		ajax.put("checkedKeys", deptService.findDeptListByRoleId(roleId));
	...
	public AjaxResult remove(@PathVariable Long deptId) {
		...
		if (deptService.checkDeptExistUser(deptId)) {
			return AjaxResult.error("部門存在用戶,不允許刪除");
		}
		deptService.deleteObject(new Long[] { deptId });
		return AjaxResult.success();
	}
}
