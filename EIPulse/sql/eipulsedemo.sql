-- (if not exist ) create database eipulsedemo;
...
create table sys_dept (
  dept_id           bigint(20)      not null auto_increment    comment '部門代號',
  parent_id         bigint(20)      default 0                  comment '父部門代號',
...
-- 初始化-部門表數據
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          'Eipulse科技',   0, '嚴凱', '0923456773', 'yenkai@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '台灣總公司', 1, '嚴凱', '0923456773', 'yenkai@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '美國分公司', 2, '陳宇', '0923456776', 'chenyu@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研發部門',   1, '湯圓', '0923456774', 'tangyuan@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '人資部門',   2, '凃珈', '0923456777', 'tujia@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '測試部門',   3, '嚴裕', '0923456775', 'u06m4d93@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '財務部門',   4, '汪君', '0923456778', 'wangjun@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '營運部門',   5, '蕭凱', '0923456779', 'xiaokai@gmail.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '行銷部門',   1, '吳員', '0923456780', 'wuyuan@gmail.com', '0', '0', 'admin', sysdate(), '', null);
...
create table sys_user (
  user_id           bigint(20)      not null   comment '員工代號',
  dept_id           bigint(20)      default null               comment '部門代號',
  ...
  primary key (user_id) 
) engine=innodb   comment = '員工資訊表';

-- ----------------------------
-- 初始化-員工資訊表數據
-- ----------------------------insert into sys_user values(1,103, 'admin', '湯圓', '00', 'tangyuan@gmail.com', '0923456774', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理員');insert into sys_user values(230002,105, 'YenYasir',    '嚴裕', '00', 'u06m4d93@gmail.com',  '0923456775', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '測試員');insert into sys_user values(230003,102, 'ChenYu',    '陳宇', '00', 'chenyu@gmail.com',  '0923456776', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '美國分部長');insert into sys_user values(230004,104, 'TuJia',    '凃珈', '00', 'tujia@gmail.com',  '0923456777', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '人資部長');insert into sys_user values(230005,106, 'WangJun',    '汪君', '00', 'wangjun@gmail.com',  '0923456778', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '財務部長');insert into sys_user values(230006,107, 'XiaoKai',    '蕭凱', '00', 'xiaokai@gmail.com',  '0923456779', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '營運部長');insert into sys_user values(230007,108, 'WuYuan',    '吳員', '00', 'wuyuan@gmail.com',  '0923456780', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '行銷部長');insert into sys_user values(230008,104, 'LiQiang',    '李強', '00', 'liqiang@gmail.com',  '0923456781', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');insert into sys_user values(230009, 104, 'WangMei',    '王美', '00', 'wangmei@gmail.com',  '0923456782', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');insert into sys_user values(230010,104,  'ZhangLi',    '張力', '00', 'zhangli@gmail.com',  '0923456783', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');insert into sys_user values(230011,104,  'ChenHui',    '陳慧', '00', 'chenhui@gmail.com',  '0923456784', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');insert into sys_user values(230012, 104, 'LiuWei',    '劉偉', '00', 'liuwei@gmail.com',  '0923456785', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');insert into sys_user values(230013, 104, 'HuangKai',    '黃凱', '00', 'huangkai@gmail.com',  '0923456786', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');insert into sys_user values(230014, 104, 'LinLian',    '林蓮', '00', 'linlian@gmail.com',  '0923456787', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');
insert into sys_user values(230015,103, 'YangJian',    '楊健', '00', 'yangjian@gmail.com',  '0923456788', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');
insert into sys_user values(230016,103, 'ZhouMing',    '周明', '00', 'zhouming@gmail.com',  '0923456789', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');
insert into sys_user values(230017,106, 'WuYu',    '吳玉', '00', 'wuyu@gmail.com',  '0923456790', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');
insert into sys_user values(230018,106, 'XuJun',    '許俊', '00', 'xujun@gmail.com',  '0923456791', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');
insert into sys_user values(230019,107, 'CaiLi',    '蔡麗', '00', 'caili@gmail.com',  '0923456792', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');
insert into sys_user values(230020,107, 'ZhengJie',    '鄭杰', '00', 'zhengjie@gmail.com',  '0923456793', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '員工');
...
create table sys_role (
  role_id              bigint(20)      not null auto_increment    comment '角色代號',
...
create table sys_menu (
  menu_id           bigint(20)      not null auto_increment    comment '菜單代號',
  menu_name         varchar(50)     not null                   comment '菜單名稱',
  parent_id         bigint(20)      default 0                  comment '父菜單代號',
  order_num         int(4)          default 0                  comment '顯示順序',
...
insert into sys_menu values('113',  '緩存監控', '2',   '5', 'cache',      'monitor/cache/index',      '', 1, 0, 'C', '0', '0', 'monitor:cache:list',      'redis',         'admin', sysdate(), '', null, '緩存監控菜單');
...
insert into sys_menu values('116',  '系統接口', '3',   '3', 'swagger',    'tool/swagger/index',       '', 1, 0, 'C', '0', '0', 'tool:swagger:list',       'swagger',       'admin', sysdate(), '', null, '系統接口菜單');
-- 三級菜單
...
insert into sys_menu values('1007', '重置密碼', '100', '7',  '', '', '', 1, 0, 'F', '0', '0', 'system:user:resetPwd',       '#', 'admin', sysdate(), '', null, '');
-- 角色管理按鈕
...
-- 在線員工按鈕
insert into sys_menu values('1046', '在線查詢', '109', '1', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:query',       '#', 'admin', sysdate(), '', null, '');
insert into sys_menu values('1047', '批量強退', '109', '2', '#', '', '', 1, 0, 'F', '0', '0', 'monitor:online:batchLogout', '#', 'admin', sysdate(), '', null, '');
...
create table sys_user_role (
  user_id   bigint(20) not null comment '員工代號',
  role_id   bigint(20) not null comment '角色代號',
...
insert into sys_user_role values ('230002', '2');
insert into sys_user_role values ('230003', '2');
insert into sys_user_role values ('230004', '2');
insert into sys_user_role values ('230005', '2');
insert into sys_user_role values ('230006', '2');
insert into sys_user_role values ('230007', '2');
insert into sys_user_role values ('230008', '2');
insert into sys_user_role values ('230009', '2');
insert into sys_user_role values ('230010', '2');
insert into sys_user_role values ('230011', '2');
insert into sys_user_role values ('230012', '2');
insert into sys_user_role values ('230013', '2');
insert into sys_user_role values ('230014', '2');
insert into sys_user_role values ('230015', '2');
insert into sys_user_role values ('230016', '2');
insert into sys_user_role values ('230017', '2');
insert into sys_user_role values ('230018', '2');
insert into sys_user_role values ('230019', '2');
insert into sys_user_role values ('230020', '2');
...
create table sys_role_menu (
  role_id   bigint(20) not null comment '角色代號',
  menu_id   bigint(20) not null comment '菜單代號',
...
create table sys_role_dept (
  role_id   bigint(20) not null comment '角色代號',
  dept_id   bigint(20) not null comment '部門代號',
...
(
  user_id   bigint(20) not null comment '員工代號',
  post_id   bigint(20) not null comment '職位代號',
...
insert into sys_user_post values ('230002', '2');
insert into sys_user_post values ('230003', '2');
insert into sys_user_post values ('230004', '2');
insert into sys_user_post values ('230005', '2');
insert into sys_user_post values ('230006', '2');
insert into sys_user_post values ('230007', '2');
insert into sys_user_post values ('230008', '3');
insert into sys_user_post values ('230009', '3');
insert into sys_user_post values ('230010', '3');
insert into sys_user_post values ('230011', '3');
insert into sys_user_post values ('230012', '3');
insert into sys_user_post values ('230013', '3');
insert into sys_user_post values ('230014', '3');
insert into sys_user_post values ('230015', '4');
insert into sys_user_post values ('230016', '4');
insert into sys_user_post values ('230017', '4');
insert into sys_user_post values ('230018', '4');
insert into sys_user_post values ('230019', '4');
insert into sys_user_post values ('230020', '4');
-- ----------------------------
-- 10、操作日誌記錄
-- ----------------------------
...
insert into sys_dict_data values(10, 1,  '默認',     'DEFAULT', 'sys_job_group',       '',   '',        'Y', '0', 'admin', sysdate(), '', null, '默認分組');
insert into sys_dict_data values(11, 2,  '系統',     'SYSTEM',  'sys_job_group',       '',   '',        'N', '0', 'admin', sysdate(), '', null, '系統分組');
insert into sys_dict_data values(12, 1,  '是',       'Y',       'sys_yes_no',          '',   'primary', 'Y', '0', 'admin', sysdate(), '', null, '系統默認是');
...
insert into sys_config values(1, '主框架頁-默認外觀樣式名稱',     'sys.index.skinName',            'skin-blue',     'Y', 'admin', sysdate(), '', null, '藍色 skin-blue、綠色 skin-green、紫色 skin-purple、紅色 skin-red、黃色 skin-yellow' );
...
insert into sys_config values(4, '帳號自助-驗證碼開關',           'sys.account.captchaOnOff',      'true',          'Y', 'admin', sysdate(), '', null, '是否開啟驗證碼功能（true開啟，false關閉）');
insert into sys_config values(5, '帳號自助-是否開啟員工註冊功能', 'sys.account.registerUser',      'false',         'Y', 'admin', sysdate(), '', null, '是否開啟註冊員工功能（true開啟，false關閉）');
...
create table sys_logininfor (
  info_id        bigint(20)     not null auto_increment   comment '訪問代號',
...
create table sys_job (
  job_id              bigint(20)    not null auto_increment    comment '任務代號',
...
create table sys_job_log (
  job_log_id          bigint(20)     not null auto_increment    comment '任務日誌代號',
...
create table sys_notice (
  notice_id         int(4)          not null auto_increment    comment '公告代號',
...
create table gen_table (
  ...
  module_name       varchar(30)                                comment '生成模塊名',
...
create table gen_table_column (
  ...
  html_type         varchar(200)                               comment '顯示類型（文本框、文本域、下拉框、覆選框、單選框、日期控件）',
