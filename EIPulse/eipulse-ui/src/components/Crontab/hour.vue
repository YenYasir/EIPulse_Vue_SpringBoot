	...
	<el-form size="small">
		...
		<el-form-item>
			<el-radio v-model='radioValue' :label="2">
				...
				<el-input-number v-model='cycle02' :min="0" :max="60" /> 小時
			</el-radio>
		</el-form-item>
		...
		<el-form-item>
			<el-radio v-model='radioValue' :label="3">
				從
				<el-input-number v-model='average01' :min="0" :max="60" /> 小時開始，每
				<el-input-number v-model='average02' :min="0" :max="60" /> 小時執行一次
			</el-radio>
		</el-form-item>
