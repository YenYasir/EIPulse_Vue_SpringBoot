...
public class Convert {
	...
	/**
	 * 轉換為字串<br>
	 * 如果給定的值為<code>null</code>，或者轉換失敗，返回默認值<code>null</code><br>
	 * 轉換失敗不會報錯
	 *
	 * @param value 被轉換的值
	 * @return 結果
	...
	/**
	 * 轉換為byte<br>
	 * 如果給定的值為<code>null</code>，或者轉換失敗，返回默認值<br>
	 * 轉換失敗不會報錯
	 *
	 * @param value        被轉換的值
	 * @param defaultValue 轉換錯誤時的默認值
	...
	/**
	 * 轉換為Number<br>
	 * 如果給定的值為空，或者轉換失敗，返回默認值<code>null</code><br>
	 * 轉換失敗不會報錯
	 *
	 * @param value 被轉換的值
	 * @return 結果
	...
	/**
	 * 轉換為boolean<br>
	 * String支持的值為：true、false、yes、ok、no，1,0 如果給定的值為空，或者轉換失敗，返回默認值<br>
	 * 轉換失敗不會報錯
	 *
	 * @param value        被轉換的值
	 * @param defaultValue 轉換錯誤時的默認值
	 ...
	 *
	 * @param data    字串
	 * @param charset 字符集，如果此字段為空，則解碼的結果取決於平台
	 * @return 解碼後的字串
	 */
