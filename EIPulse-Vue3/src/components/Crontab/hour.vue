    ...
    <el-form size="small">
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="2">
                ...
                <el-input-number v-model='cycle02' :min="cycle01 + 1" :max="23" /> 時
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
                從
                <el-input-number v-model='average01' :min="0" :max="22" /> 時開始，每
                <el-input-number v-model='average02' :min="1" :max="23 - average01" /> 小時執行一次
            </el-radio>
        </el-form-item>
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="4">
                指定
                <el-select clearable v-model="checkboxList" placeholder="可多選" multiple :multiple-limit="10">
